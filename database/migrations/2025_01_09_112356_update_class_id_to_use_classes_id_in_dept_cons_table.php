...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('dept_consent', function (Blueprint $table) {
            $table->bigInteger('temp_class_id')->nullable();
        });

        //populate it based from the dept_consent data x classes
        DB::statement('UPDATE dept_consent SET temp_class_id = classes.id FROM classes where dept_consent.class_id = classes.class_nbr and dept_consent.term = classes.term_id');
